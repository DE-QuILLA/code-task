...
from kraken_modules.utils.exceptions.kraken_custom_exceptions import KrakenProdcuerActivePairTypeException
...
# TODO: 아래 명세에 맞춘 변환 로직 추가 in airflow_pod_scripts 쪽 => 데이터 모델 추가 + 모듈화 재시작해야함.
class KrakenActivePairDataModel(BaseModel):
    ...
    def parse_decimal_fields(cls, v, info):
        try:
            ...
            raise KrakenProdcuerActivePairTypeException(
